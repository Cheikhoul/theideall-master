 ...
 */
final class Version20220317112254 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event ADD address VARCHAR(256) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event DROP address, CHANGE name name VARCHAR(96) NOT NULL COLLATE `utf8_unicode_ci`, CHANGE language language VARCHAR(32) NOT NULL COLLATE `utf8_unicode_ci`, CHANGE customer customer VARCHAR(96) NOT NULL COLLATE `utf8_unicode_ci`');
